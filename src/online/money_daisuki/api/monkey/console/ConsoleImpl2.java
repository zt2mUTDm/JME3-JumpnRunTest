...
/*public final class ConsoleImpl2 implements ConsoleGui {
	private final AtDetach atDeTach;
	...
	public ConsoleImpl2(final AtDetach atDeTach, final BitmapText inputText, final BitmapText outputText, final int outputTextLineCount) {
		this.atDeTach = Requires.notNull(atDeTach, "atDeTach == null");
