...
public final class MoveControlledSpatialControl2 /*implements Control*/ {/*
	...
	public MoveControlledSpatialControl2(final Application app, final float speed) {
	...
	public Control cloneForSpatial(final Spatial spatial) {
		return(new MoveControlledSpatialControl2(app, speed));
	}
