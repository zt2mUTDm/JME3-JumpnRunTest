...
public final class AddCharacterCommand implements Command {
	...
	public void execute(final Spatial a, final String[] b, final Runnable done) {
		...
		final String targetName = String.valueOf(b[11]);
		
		final Node target = nodeTarget.convert(targetName, a);
	...
	private boolean isConditionFulfilled(final JsonMap map, final VariablesManager vars) {
