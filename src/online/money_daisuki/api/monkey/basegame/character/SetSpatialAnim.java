...
public final class SetSpatialAnim implements Command {
	private final BiConverter<String, Spatial, Spatial> target;
	
	public SetSpatialAnim(final BiConverter<String, Spatial, Spatial> biConverter) {
