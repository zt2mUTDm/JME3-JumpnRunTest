...
public final class SetCameraFrustumLeftCommand implements Command {
	private final Camera cam;
	
	public SetCameraFrustumLeftCommand(final Camera cam) {
	...
	public void execute(final Spatial caller, final String[] cmd, final Runnable done) {
		...
		cam.setFrustumLeft(Float.parseFloat(cmd[1]));
		done.run();
	}
}
