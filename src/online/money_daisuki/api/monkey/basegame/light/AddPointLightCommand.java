...
public final class AddPointLightCommand implements Command {
	private final BiConverter<String, Spatial, Spatial> spatialTarget;
	
	public AddPointLightCommand (final BiConverter<String, Spatial, Spatial> spatialTarget) {
	...
	public void execute(final Spatial a, final String[] b, final Runnable done) {
		...
		final float r = Float.parseFloat(b[9]);
