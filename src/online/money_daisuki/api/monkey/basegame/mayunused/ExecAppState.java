...
import online.money_daisuki.api.monkey.basegame.script.ScriptLineExecutor;
...
public final class ExecAppState implements MayDoneAppState {
	...
	public ExecAppState(final ScriptLineExecutor exec, final boolean looped, final Runnable doneCallback) {
