...
public final class ShowControlledTextCommand implements Command {
	private final ShowTextAppState showText;
	private final InputManager input; 
	private final SimpleApplication app;
	
	public ShowControlledTextCommand(final ShowTextAppState showText, final InputManager input, final SimpleApplication app) {
