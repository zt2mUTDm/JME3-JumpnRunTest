...
public final class SetAudioDirectionalCommand implements Command {
	private final BiConverter<String, Spatial, Spatial> spatialTarget;
	
	public SetAudioDirectionalCommand(final BiConverter<String, Spatial, Spatial> spatialTarget) {
	...
	public void execute(final Spatial caller, final String[] cmd, final Runnable done) {
		...
		if(spatial instanceof AudioNode) {
			...
			((AudioNode) spatial).setDirectional(bool);
		} else {
