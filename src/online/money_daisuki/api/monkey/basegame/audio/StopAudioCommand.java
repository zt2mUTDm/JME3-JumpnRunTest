...
public final class StopAudioCommand implements Command {
	private final BiConverter<String, Spatial, Spatial> spatialTarget;
	
	public StopAudioCommand(final BiConverter<String, Spatial, Spatial> spatialTarget) {
