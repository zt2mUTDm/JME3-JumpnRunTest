...
public final class PauseAudioCommand implements Command {
	private final BiConverter<String, Spatial, Spatial> spatialTarget;
	
	public PauseAudioCommand(final BiConverter<String, Spatial, Spatial> spatialTarget) {
