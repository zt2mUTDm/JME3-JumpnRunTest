...
public final class ClearVariablenTypeCommand implements Command {
	private final ExtendedApplication app;
	
	public ClearVariablenTypeCommand(final ExtendedApplication app) {
